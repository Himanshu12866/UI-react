            ...
            <div className="card w-75">
                ...
                <div className="card-body">
                    <form className="p-2" onSubmit={formik.handleSubmit}>
                        ...
                        <input className="form-control m-1" type="text" name="Username" onChange={formik.handleChange} onBlur={formik.handleBlur} placeholder="Enter Your Name"></input>
                        <div className="text-danger">{formik.errors.Username}</div>
                        <label className="form-label my-2">Age :</label>
                        <input className="form-control m-1" type="text" name="Age" onChange={formik.handleChange} onBlur={formik.handleBlur}  placeholder="Please Enter Age" ></input>
                        <div className="text-danger">{formik.errors.Age}</div>
                        <label className="form-label my-2"> Mobile No. :</label>
                        <input className="form-control" type="text" name="Mobile" onChange={formik.handleChange} onBlur={formik.handleBlur}  placeholder="Enter Your Mobile No. :"></input>
                        <div className="text-danger">{formik.errors.Mobile}</div>
                        <select className="form-select my-2" name="city" onChange={formik.handleChange} onBlur={formik.handleBlur} >
